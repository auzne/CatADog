...
public class UserController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> InsertViewModel(UserFormViewModel viewModel)
    {
        try
        {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> UpdateViewModel([FromBody] UserFormViewModel viewModel, long id)
    {
        try
        {
