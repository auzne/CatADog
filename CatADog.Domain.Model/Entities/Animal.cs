...
{
    [StringLength(45, MinimumLength = 40)] public virtual string? Microchip { get; set; }
    ...
    [Required] public virtual Sex Sex { get; set; }

    [Required] public virtual bool Ccz { get; set; }
